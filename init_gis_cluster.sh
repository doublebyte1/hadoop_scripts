...
wget -S -T 10 -t 5 --no-check-certificate -O /home/hadoop/esri-git/brickhouse-0.6.0.jar https://s3-eu-west-1.amazonaws.com/emr-gis-bdigital/bootstrap/brickhouse-0.6.0.jar

wget -S -T 10 -t 5 --no-check-certificate -O /home/hadoop/esri-git/csv-serde-1.1.2-0.11.0-all.jar https://s3-eu-west-1.amazonaws.com/emr-gis-bdigital/bootstrap/csv-serde-1.1.2-0.11.0-all.jar
